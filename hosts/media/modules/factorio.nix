...
in
{
  ...
  options.myServices.factorio-server.enable = lib.mkEnableOption "The factorio dedicated server and web interface";

  config = lib.mkIf config.myServices.factorio-server.enable {
    systemd.tmpfiles.settings."10-factorio" = {
      ...
      "${factorioData}/factorio".d = {
        user = "games";
        group = "games";
        mode = "2770";
      };
      "${factorioData}/factorio/mods".d = {
        user = "games";
        group = "games";
        mode = "2770";
      };
      "${factorioData}/factorio/saves".d = {
        user = "games";
        group = "games";
        mode = "2770";
      };
      "${factorioData}/factorio/config".d = {
        user = "games";
        group = "games";
        mode = "2770";
      };
      "${factorioData}/fsm-data".d = {
        user = "games";
        group = "games";
        mode = "2770";
      };
